...
```bash
git clone https://github.com/daveydhruti/llm-ids.git
...
python3 llm-ids/convvert.py output.csv
# Generate a balanced dataset for training
python3 llm-ids/balance_dataset.py output.jsonl
```
...
cp ../llm-ids/config/mistral_config.yaml ./config.yaml
...
```bash
cp ../llm-ids/finetune_test_llama.py ./finetune_test.py
```
